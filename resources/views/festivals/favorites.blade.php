...
<div class="container favorites">
    ...
    {{-- <div class="container" *ngIf="authService.isLoggedIn">
        ...
        <div class="justify-content-right text-right"> <button id="logout" class="btn btn-primary" *ngIf="authService.isLoggedIn" (click)="authService.logout()">Logout</button></div>
        
        <div id="nofavs" *ngIf="(festivals$ | async) === null">No favorites in list</div>

        <div class="favorites"></div>
        <div class="row row-cols-1 row-cols-md-5">
            <div class="col mb-1" *ngFor="let festival of festivals$ | async">
                <div class="card">
                    <img src="/assets/img/{{festival.img}}" class="card-img-top" alt="{{festival.name}}">
                    <div class="card-body">
